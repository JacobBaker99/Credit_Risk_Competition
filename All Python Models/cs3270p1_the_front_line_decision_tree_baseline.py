...
and train_base.csv. This is the default Deision tree from sklearn with a max depth of 70.
'''
...
def test(X_scaled, y):
    ...
    for train_index, test_index in skf.split(X_scaled, y):
        ...
        dt_model = tree.DecisionTreeClassifier(criterion='entropy', random_state=SEED, max_depth=70)
